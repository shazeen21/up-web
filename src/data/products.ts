...
export const kyddozCollection: Product[] = [
  ...
  {
    id: "ky-1937",
    name: "Wooden Doorplate",
    price: 550,
    image: "/images/kyddoz/ky-19/door.jpeg",
    images: [
      "/images/kyddoz/ky-19/door.jpeg"
    ],
    brand: "kyddoz",

    features: [
      "Custom-crafted wooden nameplate with vibrant 3D effect",
      "Personalised with name in bold, fun fonts",
      "Pastel color palette to enhance room décor",
      "High-quality durable finish",
      "Ideal for bedroom doors, toy storage, or study corners",
      "Perfect for kids’ rooms and gifting"
    ],
